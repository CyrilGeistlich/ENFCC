...
WAICC$emissions_per_capita_700 <- ((WAICC$emissions_per_capita - 700)/700)
WAICC$emissions_per_capita_700_scaled <- (-WAICC$emissions_per_capita/max(WAICC$emissions_per_capita))* 2 + 1
...
WAICC <- WAICC |>
  mutate(dim_1 = emissions_per_capita_700_scaled) |>
