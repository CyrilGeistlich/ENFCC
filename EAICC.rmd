...
netline <- ggplot(enfcc, aes(x = weighted_projected_emissions, y = tot_mit_reverse, color = classification)) +
  ...
  geom_text(x = 75000, y = 90000, label = "Net-Zero-Goal 2050", hjust = 0, vjust = 0, size = 4, angle = 61, color = "black") +
  geom_text(x = 172000, y = 90000, label = "55%-Goal 2030", hjust = 0, vjust = 0, size = 4, angle = 61, color = "black") +
  geom_text_repel(aes(weighted_projected_emissions, tot_mit_reverse, label = country), size = 2, force = 1, max.overlaps = 50, color = "black") +
  theme(
...
netline_per_capita <- ggplot(enfcc_per_capita, aes(x = weighted_projected_emissions_pop * 1000, y = tot_mit_reverse_pop * 1000, color = classification_per_capita)) +
  ...
  geom_text(x = 5, y = 5.5, label = "Net-Zero-Goal 2050", hjust = 0, vjust = 0, size = 4, angle = 27, color = "black") +
  geom_text(x = 9, y = 3.1, label = "55%-Goal 2030", hjust = 0, vjust = 0, size = 4, angle = 27, color = "black") +
  geom_text_repel(aes(weighted_projected_emissions_pop * 1000, tot_mit_reverse_pop * 1000, label = country), 
                  size = 2, force = 1, max.overlaps = 50, color = "black") +
  theme(
...
netline_zoom <- ggplot(enfcc, aes(weighted_projected_emissions, tot_mit_reverse, color = classification)) +
  ...
  geom_abline(slope = 1, linetype = "dashed") +
  geom_abline(slope = 1, intercept = -baseline_1990, linetype = "dashed") +
  geom_text(x = 80000, y = 82000, label = "Net-Zero-Goal 2050", hjust = -0.1, vjust = -0.1, size = 4, angle = 45, color = "black") +
  geom_text(x = 120000, y = 30000, label = "55%-Goal 2030", hjust = 0, vjust = 0, size = 4, angle = 45, color = "black") +
  geom_text_repel(aes(weighted_projected_emissions, tot_mit_reverse, label = country), size = 2, force = 1, max.overlaps = 50, color = "black") +
  theme(
    axis.text.x = element_text(angle = 0, vjust = 0.75),
    axis.title = element_text(size = 12),
...
netline_per_capita_zoom <- ggplot(enfcc_per_capita, aes(weighted_projected_emissions_pop * 1000, tot_mit_reverse_pop * 1000, color = classification_per_capita)) +
  ...
  geom_text(x = 7.5, y = 6.5, label = "Net-Zero-Goal 2050", hjust = 0, vjust = 0, size = 4, angle = 26, color = "black") +
  geom_text(x = 9, y = 3.1, label = "55%-Goal 2030", hjust = 0, vjust = 0, size = 4, angle = 26, color = "black") 
